...
export default defineConfig({
  root: '.',
  publicDir: 'public',
  // GitHub Pages serves the build at https://ikerio.github.io/Nevula/, so
  // every asset URL needs the `/Nevula/` prefix or browsers 404 on JS/CSS
  // imports. Dev server ignores `base`.
  base: '/Nevula/',
  server: {
    port: 5173,
    open: true,
